...
#
#   Important for souring:
#
#   (2) This script must be sourced using the bash or ksh shells only. If run
#       directly, you don't need to set GRADLE_HOME.
#
##############################################################################
...
# This is reliable if the home directory to not contain symlinks.
